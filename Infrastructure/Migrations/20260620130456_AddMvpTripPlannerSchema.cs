...
{
    /// <inheritdoc />
    public partial class AddMvpTripPlannerSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetPasswordExpiration = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("DestinationCacheProviderPlaceId", x => x.ProviderPlaceId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceUuid = table.Column<Guid>(type: "uuid", nullable: false),
                    RefreshToken = table.Column<string>(type: "text", nullable: false),
                    RefreshTokenExpiration = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ...
                    LocationInfo = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("EmailVerificationTokenId", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmailVerificationTokens_Users",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("TripId", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Trips_Users",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ItineraryDayId", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItineraryDays_Trips",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("TripDestinationId", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripDestinations_ItineraryDays",
                        column: x => x.ItineraryDayId,
                        principalTable: "ItineraryDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TripDestinations_Trips",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItineraryDays_TripId_DayIndex",
                table: "ItineraryDays",
                columns: new[] { "TripId", "DayIndex" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TripDestinations_ItineraryDayId",
                table: "TripDestinations",
                column: "ItineraryDayId");

            migrationBuilder.CreateIndex(
                name: "IX_TripDestinations_TripId_ItineraryDayId_Position",
                table: "TripDestinations",
                columns: new[] { "TripId", "ItineraryDayId", "Position" });
